...
import { AppBar, Toolbar, IconButton, Typography, Button, Grid, Menu, MenuItem, InputBase, Popover, Popper, Paper } from '@material-ui/core';
import { Menu as MenuIcon, ArrowDownward, ArrowDropDown, Search } from '@material-ui/icons';
...
export const Nav = memo(({ isLoggedIn, logoutCallback, categories }: NavProps) => {
          ...
          <Toolbar>
            <Grid container justify="space-between" direction="row">
              ...
              <Grid item container alignItems="center" xs>
                ...
                <LinkComponent to="/" isButton>Democracy</LinkComponent>
                <SearchInput />
              </Grid>
              ...
              <Grid item container alignItems="center" xs justify="flex-end">
                <Typography
                  ...
                  component="span"
                >
                  <Grid container alignItems="center" className="MuiButton-root" ref={menuRef}>
...

                {
                  isLoggedIn && (
                    <>
                      ...
                      <Button href="/logout" color="inherit">Se déconnecter</Button> 
                    </>
                  )
                }      
              </Grid>   
