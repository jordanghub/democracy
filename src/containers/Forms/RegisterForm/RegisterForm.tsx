...
export const RegisterFormComponent = ({ handleSubmit, form, submitting}: FormRenderProps) => {
  ...
  return (
    <Styled.Form onSubmit={handleSubmit}>      
      ...
      <Button variant="contained" type="submit" disabled={submitting || isSuccess}>Envoyer</Button>
    </Styled.Form>
  )
}
...

      {
        isSuccess && (
          <Alert severity="success">   
            ...
            <span>Vous pouvez maintenant vous connecter en cliquant <LinkComponent to="/login">ici</LinkComponent></span>
          </Alert>
        )
      }
